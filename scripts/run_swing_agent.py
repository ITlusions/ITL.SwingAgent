...
def main():
    ...
    ap.add_argument("--db", default="data/swing_agent.sqlite", help="centralized database sqlite path")
    ap.add_argument("--vec-db", default="data/swing_agent.sqlite", help="vector database sqlite path (same as --db for centralized database)")
