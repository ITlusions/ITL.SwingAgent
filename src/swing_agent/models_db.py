...
class Signal(Base):
    ...
    @hybrid_property
    def llm_vote(self) -> Optional[Dict[str, Any]]:
    ...
    @llm_vote.setter
    def llm_vote(self, value: Optional[Dict[str, Any]]):
    ...
    @hybrid_property
    def scenarios(self) -> Optional[list]:
    ...
    @scenarios.setter
    def scenarios(self, value: Optional[list]):
